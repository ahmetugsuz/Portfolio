        ...
        <AboutRow>
            ...
            <div className='column3'>
              ...
              onInit={(typewriter2)  => { 
                ...
                typeString(" I am Ahmet, 21 years old Software Engineer located in Norway. Well-organised person, problem solver, independet employee with a high attention to detail and pattern.").pauseFor(500).
                typeString(" As a University of Oslo graduate I am a huge passionated programmer. ").pauseFor(500).
